    ...
    <section id="feedback" className="py-12 sm:py-20 bg-slate-50">
      <div
        className="
          ...
          bg-gradient-to-br from-[#007488] to-[#004e5b]
          mx-auto max-w-7xl
          shadow-2xl shadow-[#007488]/20
        "
      ...
      >
        ...
        <div className="relative w-full px-4 sm:px-10 lg:px-14 py-12">
          ...
          <div className="flex flex-col items-center text-center mb-12 sm:mb-16">
            <span className="inline-flex items-center gap-2 px-3 py-1.5 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 mb-4 text-xs font-bold uppercase tracking-widest text-[#a3e635]">
              Community Feedback
            </span>
          ...
          <div className="relative group/slider">
                      ...
                      <div className="relative z-10 flex flex-col h-full">
                        <div className="flex justify-between items-start gap-3">
                          <div className="flex items-center gap-3.5">
                            {/* Avatar */}
                            <div className="w-12 h-12 rounded-full bg-gradient-to-br from-[#00A7B5] to-[#007488] flex items-center justify-center text-white font-bold text-sm shadow-md">
                              {getInitials(t.name)}
                            </div>
                            <div>
            ...
            <button
              ...
              className={`
                ...
                flex items-center justify-center text-[#007488]
          ...
          <div className="mt-12 flex justify-center items-center gap-2.5">
            {[...Array(maxIndex + 1)].map((_, i) => (
              <button
                ...
                className={`
                  h-2 rounded-full transition-all duration-500 ease-out focus:outline-none focus:ring-2 focus:ring-lime-300 focus:ring-offset-2 focus:ring-offset-[#007488]
                  ${currentIndex === i ? "w-10 bg-lime-300 shadow-[0_0_10px_rgba(190,242,100,0.5)]" : "w-2.5 bg-white/30 hover:bg-white/60"}
                `}
